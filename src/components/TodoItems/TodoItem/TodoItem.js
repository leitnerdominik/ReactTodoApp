...
class TodoItem extends Component {
  ...
  render() {
    ...
    const title = (
      <h2 className={this.props.isCompleted ? "item-title completed-item" : "item-title"}>
        {this.props.name}
      </h2>
    );
    ...
    const showEdit = !this.props.isEditing ? (
      <div
        className="editItem controls"
